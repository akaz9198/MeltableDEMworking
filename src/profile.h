...
class Cslice
{
	...
	QList <Cparticle *> P;			/**< list of particle (pointers) that have a piece of volume in the slice.*/
	QList <double> volume_in_slice; /**< list of particle volume that belong to the slice.*/
	void average();
